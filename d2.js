...
{
    /* <div class="first-catlog">
                        <img class="images" src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/7579188/2018/11/5/08a7b230-ee8f-46c0-a945-4e835a3c01c01541402833619-United-Colors-of-Benetton-Men-Sweatshirts-1271541402833444-1.jpg" alt="">
                        <div class="content-wrapper">
                            <p class="item-name">Men Navy Blue Solid Sweatshirt</p>
                            <p class="item-brand">United Colors of Benetton</p>
                            <p class="item-price">Rs 2599</p>
                        </div>
                    </div> */
}
...
function createCard() {
    ...
    for (let i = 0; i < item1.length; i++) {
        ...
        div.className = "first-catlog";

        let img = document.createElement("img");
        img.src = item1[i].preview;
        img.className = "images";

        let secondDiv = document.createElement("div");
        secondDiv.className = "content-wrapper";

        let price = document.createElement("p");
        price.innerHTML = item1[i].price;
        price.className = "item-price";

        let brand = document.createElement("p");
        brand.innerHTML = item1[i].brand;
        brand.className = "item-brand";

        let itemName = document.createElement("p");
        itemName.innerHTML = item1[i].name;
        itemName.className = "item-name";

        secondDiv.appendChild(itemName);
        secondDiv.appendChild(brand);
        secondDiv.appendChild(price);


        // console.log(img, secondDiv);
